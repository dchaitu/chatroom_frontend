            ...
            <div className="flex-1 max-w-2xl mx-auto">
                <div className="relative">
                    <input
                        ...
                        className="w-full px-3 py-2 pl-10 pr-4 text-sm text-white bg-gray-700 rounded-md border-none outline-none placeholder-gray-400 focus:ring-2 focus:ring-blue-500"
                    />
